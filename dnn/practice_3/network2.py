...
class Network(object):
    ...
    def predict(self, x):
        ...
        # h_l_in = (self.weights[0] @ image) + self.biases[0]
        # h_l_out = sigmoid(h_l_in)

        # o_l_in = (self.weights[1] @ h_l_out) + self.biases[1]
        # o_l_out = softmax(o_l_in)
        result = softmax(self.feedforward(x))
...
def main():
    ...
    image = image_to_tensor('/home/psyhack/Downloads/digit_7.jpg')

    print(image.shape)
    
    net.load("./network_data.json")
